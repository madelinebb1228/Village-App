...
export const darkColors: Colors = {
  ...
  reminderInfo:      { bg: '#1E3040', border: '#7BA7BC',  text: '#B8C8D8' },
  reminderWarning:   { bg: '#2A2820', border: '#B8904A',  text: '#B8C8D8' },
  reminderAlert:     { bg: '#2E2038', border: '#B8829C',  text: '#B8C8D8' },
  reminderMilestone: { bg: '#1E2E2A', border: '#6A9A84',  text: '#B8C8D8' },
  reminderStreak:    { bg: '#242035', border: '#8878A8',  text: '#B8C8D8' },

  statFeeds:   { accent: '#6A9A84', bg: '#1E2E2A' },
  statDiapers: { accent: '#B8904A', bg: '#2A2820' },
  statPumped:  { accent: '#B8829C', bg: '#2E2038' },
