...
export const darkColors: Colors = {
  ...
  reminderInfo:      { bg: '#244E7B', border: '#7BA7BC',  text: '#B8C8D8' },
  reminderWarning:   { bg: '#604326', border: '#B8904A',  text: '#B8C8D8' },
  reminderAlert:     { bg: '#68325A', border: '#B8829C',  text: '#B8C8D8' },
  reminderMilestone: { bg: '#244E38', border: '#6A9A84',  text: '#B8C8D8' },
  reminderStreak:    { bg: '#482B73', border: '#8878A8',  text: '#B8C8D8' },

  statFeeds:   { accent: '#6A9A84', bg: '#244E38' },
  statDiapers: { accent: '#B8904A', bg: '#604326' },
  statPumped:  { accent: '#B8829C', bg: '#68325A' },
