...
export type ContentType = 'post_image' | 'post_video' | 'profile_avatar' | 'baby_photo' | 'event_photo' | 'listing_photo' | 'item_photo' | 'story_photo' | 'activity_photo' | 'receipt_photo';
